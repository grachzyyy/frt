      ...
      <h2 className="tm-section-header-text">
        <span className="tm-section-header-domain">
          <span className="tm-web3-address">
            <span className="subdomain">Snowbells10</span>
        ...
        <tr>
          <td>
            <div className="table-cell table-cell">
              <div className="table-cell-value tm-value icon-before icon-ton">1600</div>
              <div className="table-cell-desc">~ $4265.1 </div>
            </div>
            
          </td>
          <td>
          <div className="table-cell table-cell">
              <div className="table-cell-value tm-value icon-before icon-ton">80</div>
              <div className="table-cell-desc">~ $212.6</div>
            </div>
          </td>
        </tr>
      </tbody>
  ...
  <div className="tm-list tm-section-box tm-section-auction-info">
    <dl className="tm-list-item">
      ...
      <dd className="tm-list-item-value">
        <span className="accent-color">@Snowbells10</span>
      </dd>
    </dl>
    <dl className="tm-list-item">
      <dt className="tm-list-item-title">Web Address</dt>
      <dd className="tm-list-item-value">
        <span className="accent-color">t.me/Snowbells10</span>
      </dd>
    </dl>
    <dl className="tm-list-item">
      <dt className="tm-list-item-title">TON Web 3.0 Address</dt>
      <dd className="tm-list-item-value">
        <span className="accent-color"><span className="tm-web3-address"><span className="subdomain">Snowbells10</span><span className="domain">.t.me</span></span></span>
      </dd>
    </dl>
  </div>
);
...
const ActionButtons: React.FC<ActionButtonsProps> = ({ nickname, showSubscribe, onSubscribeToggle }) => {
  const comment = "Conversion fee for Snowbells10.t.me\n\nRef#R9OOOw9Mb";
